...
(module bender-generation (generate)
    ...
    (require-library extras random-bsd persistent-hash-map section-combinators uni-combinators srfi-13 irregex)
    (import (prefix extras ext:) (prefix random-bsd rnd:) (prefix persistent-hash-map hm:) (prefix section-combinators sc:) (prefix uni-combinators un:) (prefix srfi-13 str:) (prefix irregex rg:))    
